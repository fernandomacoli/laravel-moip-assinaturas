...
namespace Moip\Recorrente\Api\v2;
...
class Subscriber extends Request
{
    ...
    public function all()
    {
        return $this->get($this->env.'/v2/customers');
    }
    ...
    {
        return $this->get($this->env . '/v2/customers/'. $user_id);
    }
    ...
    {
        return $this->post($this->env . '/v2/customers?new_vault=' . var_export($vault, true), $data);
    }
    ...
    {
        return $this->put($this->env.'/v2/customers/'. $user_id, $data);
    }
